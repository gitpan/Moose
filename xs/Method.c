 ...
 * contents of Method.xs. Do not edit this file, edit Method.xs instead.
 *
...
extern "C"
#endif
XS(boot_Class__MOP__Method); /* prototype to pass -Wmissing-prototypes */
XS(boot_Class__MOP__Method)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
